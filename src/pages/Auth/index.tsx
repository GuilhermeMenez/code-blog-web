    ...
    <Flex className="auth-wrapper" justify="center" align="center">
      <Card className="auth-card" size="3">
        <Flex direction="row" className="auth-content">
          <Flex className="auth-landing" direction="column" justify="end">
            <Flex direction="column" gap="2">
              ...
              <Text className="auth-subtitle" weight="regular">
                Compartilhe <span style={{ textDecoration: ' line-through' }}></span> conhecimento
                com a comunidade.
              </Text>
            </Flex>
          </Flex>

          <Flex className="auth-form" direction="column" align="center" justify="center">
            {isLogin ? (
