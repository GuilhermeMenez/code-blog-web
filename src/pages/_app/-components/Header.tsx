  ...
  return (
    <div className="sticky inset-x-0 top-0 flex justify-end items-center w-full h-17.5 py-4 px-6 z-1000">
      <div className="flex gap-4">
        <button type="button" className="gap-2 p-1 rounded-xs header-item focus-ring">
        ...
        <button type="button" className="relative gap-2 p-1 rounded-xs header-item focus-ring">
          <div className="icon-box">
            <div className="dot" />
        ...
        <button type="button" className="group p-0.5 ml-1 rounded-full header-item focus-ring">
          <Avatar
            src={srcMock}
            letter="CB"
          />
